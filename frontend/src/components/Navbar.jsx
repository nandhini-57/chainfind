...
export default function Navbar({ wallet, onConnect, connecting }) {
      ...
      <div className="flex items-center justify-between px-6 py-3">
        ...
        <div className="flex items-center gap-3">
          {wallet ? (
            ...
            <button
              type="button"
              className="py-2 px-4 rounded-xl font-semibold text-sm flex items-center gap-2 transition-all hover:scale-105 hover:shadow-lg disabled:cursor-not-allowed disabled:hover:scale-100"
              onClick={() => onConnect()}
              disabled={connecting}
              style={{
                background: 'linear-gradient(135deg, #fbbf24 0%, #f97316 100%)',
